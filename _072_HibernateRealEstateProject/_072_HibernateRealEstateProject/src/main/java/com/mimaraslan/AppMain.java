...
/*        Ev ev = Ev.builder()
    ...
    private static void evAra() {
        ...
        Arac arac = evController.evAraById(id);
    ...
    private static void evKirala() {
        ...
        Arac arac = evController.evAraById(id);
        arac.setDurum(EEvStatus.KIRADA);
        System.out.println("EV BİLGİSİ: " + arac);
    ...
    private static void kiradakiEvler() {
      //  System.out.println(evController.kiradakiEvler());
        ...
        List<Arac> evlerListesi = evController.kiradakiEvler();
        for (Arac arac : evlerListesi) {
            //System.out.println(ev);
            System.out.println("Durumu: " + arac.getDurum() + "\t Id: " + arac.getId() + "\t Kat: " + arac.getKat() +
                    "\t Türü: " + arac.getTur() + "\t Semt: " + arac.getSemt() + "\t Yılı: "+ arac.getYapimYili());
        }
    }
    ...
    private static void musaitEvler() {
      //  System.out.println(evController.musaitEvler());
        ...
        List<Arac> evlerListesi = evController.musaitEvler();
        for (Arac arac : evlerListesi) {
            //System.out.println(ev);
            System.out.println("Durumu: " + arac.getDurum() + "\t Id: " + arac.getId() + "\t Kat: " + arac.getKat() +
                    "\t Türü: " + arac.getTur() + "\t Semt: " + arac.getSemt() + "\t Yılı: "+ arac.getYapimYili());
