...
import com.onurbas.model.Agent;
import com.onurbas.model.Buyer;
import com.onurbas.model.Property;
import com.onurbas.model.Seller;
    ...
    public static SessionFactory getSessionFactory() {
        if (sessionFactory == null) {
            try {
                ...
                settings.put(Environment.URL, "jdbc:postgresql://localhost:5432/emlakDB");
...
/*             // MySQL 8
                ...
                settings.put(Environment.URL, "jdbc:mysql://localhost:3306/emlakDB?useSSL=false");
