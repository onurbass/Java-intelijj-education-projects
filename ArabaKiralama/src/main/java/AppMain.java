/*
 Bir araba kiralama sistemi var.
...
• Kiralama işlemlerini yapılan sınıfın içinde kiralamaYap, arabaAra, müşteriAra, kiralananArabaListesi methodlarını oluştur.
...
OtoGaleri otoGaleri = new OtoGaleri();
 ...
 otoGaleri.musteriVeKasiyerOlustur();
 otoGaleri.arabaOlustur();
        System.out.println(OtoGaleri.getArabalar());
